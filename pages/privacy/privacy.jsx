		...
		<>
			...
			>
				...
				<P>
					...
					email, & profile picture. The information that we request
					may be retained by us and used as described in this privacy
				...
				<P pl={8}>
					<ol>
						<li>
							...
							email-ID to identify you when you login again to the
							app. We do not share your email with any third
							party.
						</li>
						<li>
							<strong>Profile Picture:</strong> we do not store or
							process your profile picture in any manner and only
							use it to show your picture in the app during a
							session when you login using your social identity.
						</li>
					</ol>
				</P>
				<P>
					The app is built and hosted by Eko India Financial Services
					Pvt. Ltd. and is responsible for collecting and using the
				...
				<P>
					...
					information (through third party products) called Log Data.
