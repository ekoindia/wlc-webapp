...
describe("HistoryPagination", () => {
	it("renders without error with no attributes", () => {
		const { container } = render(<HistoryPagination />);
	...
	test.todo(
		"TODO: add proper test cases for HistoryPagination in __tests__/components/HistoryPagination/HistoryPagination.test.jsx"
	);
});
