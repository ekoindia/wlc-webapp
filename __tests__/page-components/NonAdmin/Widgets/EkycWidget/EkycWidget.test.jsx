import { EkycWidget } from "components/EkycWidget";
...
describe("EkycWidget", () => {
	it("renders without error with no attributes", () => {
		const { container } = render(<EkycWidget />);
	...
	test.todo(
		"TODO: add proper test cases for EkycWidget in __tests__/components/EkycWidget/EkycWidget.test.jsx"
	);
});
