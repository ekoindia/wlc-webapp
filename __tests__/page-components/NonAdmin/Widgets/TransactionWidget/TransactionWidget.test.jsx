...
describe("TransactionWidget", () => {
	it("renders without error with no attributes", () => {
		const { container } = render(<TransactionWidget />);
	...
	test.todo(
		"TODO: add proper test cases for TransactionWidget in __tests__/components/TransactionWidget/TransactionWidget.test.jsx"
	);
});
