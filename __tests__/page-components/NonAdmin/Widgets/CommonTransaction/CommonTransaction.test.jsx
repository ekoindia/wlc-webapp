import { CommonTransaction } from "components/CommonTransaction";
...
describe("CommonTransaction", () => {
	it("renders without error with no attributes", () => {
		const { container } = render(<CommonTransaction />);
	...
	test.todo(
		"TODO: add proper test cases for CommonTransaction in __tests__/components/CommonTransaction/CommonTransaction.test.jsx"
	);
});
