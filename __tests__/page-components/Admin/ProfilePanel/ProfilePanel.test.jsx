import ProfilePanel from "page-components/Admin/ProfilePanel/ProfilePanel";
...
describe("ProfilePanel", () => {
	it("renders without error with no attributes", () => {
		const { container } = adminRender(<ProfilePanel />);
	...
	// test.todo(
	// 	"TODO: add proper test cases for ProfilePanel in __tests__/components/ProfilePanel/ProfilePanel.test.jsx"
	// );
});
