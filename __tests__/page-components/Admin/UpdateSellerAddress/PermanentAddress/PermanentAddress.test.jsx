...
describe("PermanentAddress", () => {
	it("renders without error with no attributes", () => {
		const { container } = render(<PermanentAddress />);
	...
	test.todo(
		"TODO: add proper test cases for PermanentAddress in __tests__/components/PermanentAddress/PermanentAddress.test.jsx"
	);
});
