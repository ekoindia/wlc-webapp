...
import { NetworkTransactionHistory } from "components/NetworkTransactionHistory";
...
describe("NetworkTransactionHistory", () => {
	it("renders without error with no attributes", () => {
		const { container } = render(<NetworkTransactionHistory />);
	...
	test.todo(
		"TODO: add proper test cases for NetworkTransactionHistory in __tests__/components/NetworkTransactionHistory/NetworkTransactionHistory.test.jsx"
	);
});
