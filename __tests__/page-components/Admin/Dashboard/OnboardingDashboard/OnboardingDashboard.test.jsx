...
describe("OnboardingDashboard", () => {
	it("renders without error with no attributes", () => {
		const { container } = render(<OnboardingDashboard />);
	...
	test.todo(
		"TODO: add proper test cases for OnboardingDashboard in __tests__/components/OnboardingDashboard/OnboardingDashboard.test.jsx"
	);
});
