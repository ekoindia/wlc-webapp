...
describe("OnboardingDashboardCard", () => {
	it("renders without error with no attributes", () => {
		const { container } = render(<OnboardingDashboardCard />);
	...
	test.todo(
		"TODO: add proper test cases for OnboardingDashboardCard in __tests__/components/OnboardingDashboardCard/OnboardingDashboardCard.test.jsx"
	);
});
