...
describe("BusinessDashboardCard", () => {
	it("renders without error with no attributes", () => {
		const { container } = render(<BusinessDashboardCard />);
	...
	test.todo(
		"TODO: add proper test cases for BusinessDashboardCard in __tests__/components/BusinessDashboardCard/BusinessDashboardCard.test.jsx"
	);
});
