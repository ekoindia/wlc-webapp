...
describe("UpiMoneyTransfer", () => {
	it("renders without error with no attributes", () => {
		const { container } = pageRender(<UpiMoneyTransfer />);
	...
	test.todo(
		"TODO: add proper test cases for UpiMoneyTransfer in __tests__/components/UpiMoneyTransfer/UpiMoneyTransfer.test.jsx"
	);
});
