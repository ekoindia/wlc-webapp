...
describe("QueryCenterTable", () => {
	it("renders without error with no attributes", () => {
		const { container } = render(<QueryCenterTable />);
	...
	test.todo(
		"TODO: add proper test cases for QueryCenterTable in __tests__/components/QueryCenterTable/QueryCenterTable.test.jsx"
	);
});
