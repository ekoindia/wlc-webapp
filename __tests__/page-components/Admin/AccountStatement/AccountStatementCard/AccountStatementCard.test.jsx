...
describe("AccountStatementCard", () => {
	it("renders without error with no attributes", () => {
		const { container } = render(<AccountStatementCard />);
	...
	test.todo(
		"TODO: add proper test cases for AccountStatementCard in __tests__/components/AccountStatementCard/AccountStatementCard.test.jsx"
	);
});
