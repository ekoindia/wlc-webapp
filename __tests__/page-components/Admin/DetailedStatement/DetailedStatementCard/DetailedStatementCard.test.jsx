...
describe("DetailedStatementCard", () => {
	it("renders without error with no attributes", () => {
		const { container } = render(<DetailedStatementCard />);
	...
	test.todo(
		"TODO: add proper test cases for DetailedStatementCard in __tests__/components/DetailedStatementCard/DetailedStatementCard.test.jsx"
	);
});
