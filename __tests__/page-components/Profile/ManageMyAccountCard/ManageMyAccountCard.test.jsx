...
describe("ManageMyAccountCard", () => {
	it("renders without error with no attributes", () => {
		const { container } = pageRender(<ManageMyAccountCard />);
	...
	test.todo(
		"TODO: add proper test cases for ManageMyAccountCard in __tests__/components/ManageMyAccountCard/ManageMyAccountCard.test.jsx"
	);
});
