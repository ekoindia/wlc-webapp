...
describe("ColorPickerWidget", () => {
	it("renders without error with no attributes", () => {
		const { container } = render(<ColorPickerWidget />);
	...
	test.todo(
		"TODO: add proper test cases for ColorPickerWidget in __tests__/components/ColorPickerWidget/ColorPickerWidget.test.jsx"
	);
});
