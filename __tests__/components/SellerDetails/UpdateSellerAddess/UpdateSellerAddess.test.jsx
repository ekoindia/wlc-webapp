...
import { UpdateSellerAddess } from "components/UpdateSellerAddess";
...
describe("UpdateSellerAddess", () => {
	it("renders without error with no attributes", () => {
		const { container } = render(<UpdateSellerAddess />);
	...
	test.todo(
		"TODO: add proper test cases for UpdateSellerAddess in __tests__/components/UpdateSellerAddess/UpdateSellerAddess.test.jsx"
	);
});
