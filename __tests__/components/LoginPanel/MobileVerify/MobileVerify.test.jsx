...
describe("MobileVerify", () => {
	it("renders without error with no attributes", () => {
		const { container } = render(<MobileVerify />);
	...
	test.todo(
		"TODO: add proper test cases for MobileVerify in __tests__/components/MobileVerify/MobileVerify.test.jsx"
	);
});
