import { ShowcaseCircle } from "components/ShowcaseCircle";
...
describe("ShowcaseCircle", () => {
	it("renders without error with no attributes", () => {
		const { container } = render(<ShowcaseCircle />);
	...
	test.todo(
		"TODO: add proper test cases for ShowcaseCircle in __tests__/components/ShowcaseCircle/ShowcaseCircle.test.jsx"
	);
});
