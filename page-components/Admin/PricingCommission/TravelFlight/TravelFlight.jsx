...
import { TravelFlightDistributor, TravelFlightRetailer } from ".";
 ...
 * @example	`<TravelFlight></TravelFlight>` TODO: Fix example
 */
const TravelFlight = () => {
	...
	return (
		<Flex direction="column" gap="8">
			...
			{agentType === AGENT_TYPE.RETAILERS ? (
				<TravelFlightRetailer />
			) : (
				<TravelFlightDistributor />
			)}
		</Flex>
	);
};
