...
const TravelFlightRetailer = () => {
	const {
		validation: travelFlightValidation,
		initialVal,
		uriSegment,
	} = products.FLIGHT_BOOKING.agent;
	...
	return (
		<form onSubmit={handleSubmit(handleFormSubmit)}>
			<Flex direction="column" gap="8">
				<Form
					{...{
						parameter_list: travel_flight_retailer_parameter_list,
						formValues: watcher,
						control,
						register,
						errors,
...
export default TravelFlightRetailer;
