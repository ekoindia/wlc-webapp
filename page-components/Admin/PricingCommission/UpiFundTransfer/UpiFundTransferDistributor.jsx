...
const UpiFundTransferDistributor = () => {
	const { slabs, serviceCode } = products.UPI_FUND_TRANSFER;
	...
	const upi_fund_transfer_distributor_parameter_list = [
		{
			name: "CspList",
		...
		<form onSubmit={handleSubmit(handleFormSubmit)}>
			<Flex direction="column" gap="8">
				<Form
					{...{
						parameter_list:
							upi_fund_transfer_distributor_parameter_list,
						formValues: watcher,
						control,
						register,
						errors,
...
export default UpiFundTransferDistributor;
