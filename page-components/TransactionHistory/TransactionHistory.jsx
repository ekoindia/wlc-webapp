...
/**
 * A TransactionHistory component shows transaction history
 * @param 	{object}	prop	Properties passed to the component
 * @param	{string}	prop.prop1	TODO: Property description.
 * @param	{...*}	rest	Rest of the props passed to this component.
 * @example	`<TransactionHistory></TransactionHistory>` TODO: Fix example
 */
const TransactionHistory = () => {
	...
	const hitQuery = (abortController, key) => {
		console.log("[TransactionHistory] fetch started...", key);
		...
		fetcher(process.env.NEXT_PUBLIC_API_BASE_URL + Endpoints.TRANSACTION, {
			...
			.then((data) => {
				...
				setData(tx_list);
				console.log(
					"[TransactionHistory] fetch result...",
					key,
					tx_list
				);
			})
	...
	useEffect(() => {
		...
		return () => {
			console.log(
				"[TransactionHistory] fetch aborted... ",
				currentPage,
